-- Adds the 'very_satisfied' evaluation and rebuilds the monthly board
-- function so its summary includes the new counter.
...
as $$
  ...
  select
    ...
    count(*) filter (
      where r.self_evaluation = 'very_satisfied'
